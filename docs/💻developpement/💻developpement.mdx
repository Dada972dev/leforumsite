...
Error: 404 not found!
  ...
  ## ❓C'est quoi une Aedes?

    Une aedes est un temple , c'est donc un lieu de culte.

    ##  Aedes Saturini

    Le temple de Saturne est l'un des plus anciens temples romains construits autour du Forum Romain. 
    Dédié à Saturne, sa construction commence peut-être sous la Royauté romaine avec le  roi Tarquin le Superbe ou au début de la République romaine. 
    Sous la République, une pièce aménagée dans le temple ou à proximité immédiate abrite des documents officiels de l'État et le trésor public. 
